...
export default function AdminLoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // Store token in a cookie via API route, then redirect
    ...
    >
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          {/* Green header bar */}
          <div className="h-1.5 w-full" style={{ background: "linear-gradient(90deg, #1A6B3C, #C8860A)" }} />
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-xl font-heading font-bold text-gray-900">TradeFlow NG</h1>
              <p className="text-xs text-gray-400 mt-0.5">Admin Control Dashboard</p>
            </div>

            <h2 className="text-lg font-heading font-semibold text-gray-800 mb-1">
              Welcome back
            </h2>
